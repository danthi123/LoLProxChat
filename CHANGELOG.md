...
### Changed
- Champion classifier retrained on the current-patch Community Dragon icon set (game patch 16.14.1).
...
[v0.5.8]: https://github.com/danthi123/LoLProxChat/releases/tag/v0.5.8
